...
\textbf{Ad-hoc Reviewer:} \textit{Management Science, Southern Economic Journal, Conference on Neural Information Processing Systems (NeurIPS), ACM-Collective Intelligence, International Conference on Information Systems (ICIS), Sociological Science, International Conference on Computational Social Science (IC2S2)}

\textbf{Program Committees:} \textit{ACM Conference on Economics and Computation (2026), Conference on Digital Experimentation (CODE) (2023)}
