...
Ask Not If Human Responses are Aligned with an LLM's, Ask What Aligning an LLM Can Reveal About Humans\footnotemark[\value{footnote}] (with John J. Horton)
...
International Conference on Computational Social Science (IC$^2$S$^2$) (\textit{Scheduled});
ZEW Conference on the Economics of ICT (\textit{Scheduled});
Wharton AI and the Future of Work Conference (\textit{Scheduled});
AI, Mechanism Design and Human Behavior: Experiments and Theory NBER/CEME Decentralization Conference (\textit{Scheduled});
...
International Conference on Computational Social Science (IC$^2$S$^2$)\footnotemark[\value{footnote}];
