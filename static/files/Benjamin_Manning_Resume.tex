...
\href{https://arxiv.org/abs/2608.18265}{\bf How AI Prompts Can Teach Us About the Structure of Human Behavior}\\
...
\footnotesize
\textbf{Abstract:}
We introduce a general, easy-to-implement AI-based method for studying the structure and complexity of human behavior.
...
For instance, the type vector $(2,4)$ becomes ``You are a player characterized by the following profile: 2 out of 5 in Altruism, 4 out of 5 in Risk Aversion,'' after which it is prompted to make choices.
...
More broadly, the method can provide insights into the structure of many human behaviors.
\end{singlespace}
